...
This directory contains the Elixir agent orchestration service that polls GitHub Projects v2, creates per-issue workspaces, and runs Codex in app-server mode.
